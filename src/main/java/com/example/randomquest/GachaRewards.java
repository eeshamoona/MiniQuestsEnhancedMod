...
public final class GachaRewards {
    ...
    private static final List<RewardEntry> POOL = List.of(
            ...
            new RewardEntry(new ItemStack(com.example.randomquest.item.ModItems.BRONZE_TOKEN.get(), 1), 15),
            // ── Rare / Epic ──────────────────────────────────────────
            ...
            new RewardEntry(new ItemStack(com.example.randomquest.item.ModItems.SILVER_TOKEN.get(), 1), 8),
            new RewardEntry(new ItemStack(com.example.randomquest.item.ModItems.GOLD_TOKEN.get(), 1), 3)
    );
