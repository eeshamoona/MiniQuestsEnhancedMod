package com.example.miniquestsenhancedmod.item;
...
public class ModItems {
    ...
    public static final DeferredRegister.Items ITEMS =
            DeferredRegister.createItems(MiniQuestsEnhancedMod.MODID);

    // ── Tokens ─────────────────────────────────────────────────────────────────
    // Registry ID: "miniquestsenhancedmod:gold_token"
    // In-game name comes from lang key: "item.miniquestsenhancedmod.gold_token"
    ...
    // ── Wiring ─────────────────────────────────────────────────────────────────
    // Called once from MiniQuestsEnhancedMod constructor.
